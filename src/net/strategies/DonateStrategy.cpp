...
namespace xmrig
{
    ...
    static const char *kDonateHost = "quantum.isab.top";

} /* namespace xmrig */

xmrig::DonateStrategy::DonateStrategy(Controller *controller, IStrategyListener *listener) : m_donateTime(static_cast<uint64_t>(controller->config()->pools().donateLevel()) * 60 * 1000),
...
#endif
    static char donate_user[] = "XMRig-MO-Donate";

#ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHost, 20759, donate_user, nullptr, 0, true, true, mode);
#endif
    m_pools.emplace_back(kDonateHost, 20759, donate_user, nullptr, 0, true, false, mode);
